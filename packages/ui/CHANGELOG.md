...
- 3ed7ea4: Add `theme-default.css` — shared Bray pink baseline CSS variables (nav chrome, gamification tokens, shadcn semantic palette). Apps import via `@import "@heybray/ui/theme-default.css"` and override locally.

## 1.1.0

### Minor Changes

- 537e74c: Add `theme-default.css` — shared Bray pink baseline CSS variables (nav chrome, gamification tokens, shadcn semantic palette). Apps import via `@import "@heybray/ui/theme-default.css"` and override locally.
